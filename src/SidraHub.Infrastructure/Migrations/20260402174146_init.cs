    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "DisplayOrder", "Icon", "NameAr", "NameEn" },
                values: new object[,]
                {
                    { new Guid("3efef08d-1f7d-4d45-9ccf-9b5dd20f35a1"), 1, null, "تأسيس الشركات", "Company Setup" },
                    { new Guid("c29563dc-d0e5-4a29-8440-017b57d5287e"), 4, null, "خدمات الموارد البشرية", "HR Services" },
                    { new Guid("d936e779-4744-4c07-8eca-a911e60451c6"), 2, null, "الاستشارات القانونية", "Legal Services" },
                    { new Guid("e38f4998-3140-4135-940b-ec7d59811f5c"), 5, null, "مساحات العمل", "Workspaces" },
                    { new Guid("f245a143-d4a1-4768-bfd2-d9d28ec2a60d"), 3, null, "الخدمات المحاسبية والضريبية", "Accounting & Tax" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderServices_OrderId_ServiceId",
                table: "OrderServices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceProviders_ServiceId_ProviderId",
                table: "ServiceProviders",
