...
public interface IArticleCommentService
{
    ...
    Task<IReadOnlyList<ArticleCommentDto>> GetByUserIdAsync(string userId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<ArticleCommentDto>> GetByUserIdOrNameAsync(string userId, string? userName, CancellationToken cancellationToken = default);
